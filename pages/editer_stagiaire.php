<?php
    ...
    //variable pour recupérer l'id du stagiaire
    $ids = isset($_GET['idS'])?$_GET['idS']:0;//voir la page stagiaires.php où se trouve le lien de editer_stagiaire.php pour comprendre le choix de la methode get()

    //requête pour recupérer l'id du stagiaire dans la base de données
    ...
    //recupération du nom , prenom ... du stagiaire
         ...
         <!--nouveau panneau -->
            <div class="panel panel-primary margetop"><!--panel permet de créer des panneaux -->
                ...
                <div class="panel-body">
                     ...
                     <form method="post" action="update_stagiaire.php" class="form" enctype="multipart/form-data">
                    <!-- enctype="multipart/form-data" permet d'envoyer fichiers comme des images, document pdf...; tous ce qui est du binaire-->
                         
                          <!-- recupération de l'id du stagiaire-->
                                ...
                                <?php while($filiere= $resultatf->fetch()){ ?>
                                    ...
                                    <option value=" <?php echo $filiere['idFiliere'] ?>" 
                                        <?php if($idFiliere===$filiere['idFiliere']) echo "selected"
                                            /*si l'id de la filière en cours est égale à l'id de la filière récupérer dans la base de données alors on selectionne cette filière sinon rien */?>>
